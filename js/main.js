...
$('.strip-toggel-menu').click(function () {
    nanbarwith ? ($(".nav-tab-menu").addClass("open-menu").removeClass("close-menu"), navbar = $(".nav-tab-menu").width() - 10, $(".strip-header-nav").css("left", navbar), $(".fa-align-justify").toggleClass("fa-times"), $(".nav-tab-menu .item1").animate({
        opacity: "1",
        paddingTop: "25px"
        ...
        opacity: "1",
        paddingTop: "25px"
    }, 1600), nanbarwith = !nanbarwith) : ($(".nav-tab-menu").addClass("close-menu").removeClass("open-menu"), $(".fa-align-justify").toggleClass("fa-times"), $(".strip-header-nav").css("left", 0), $(".nav-tab-menu li").animate({
        opacity: "0",
        paddingTop: "500px"
    }, 500), nanbarwith = !nanbarwith)
});
...
async function search(y) {
    $(".loading-container").fadeIn(100)
    let meals = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=${y}`)
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="alert mt-1 alert-danger d-none" id="namealert" role="alert">
							 Characters and Numbers not allowed
						</div>
					</div>
				</div>
				<div class="col-md-6">
...
function userNameValid() {
    return /^[A-Za-z ]{1,}$/.test(userName.value)
}
